      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold mb-6 text-primary-cyan">
              Social Channels
            </h3>
                ...
                contact.href !== "#" ? (
                  ...
                  >
                    <div className="w-10 h-10 bg-gray-700/50 rounded-lg flex items-center justify-center group-hover:bg-primary-cyan/20 transition-colors">
                      {getIconComponent(
                        contact.icon,
                        "h-5 w-5 text-white group-hover:text-primary-cyan transition-colors",
                      )}
                    </div>
                    <div>
          ...
          <div className="gradient-card rounded-2xl p-8 border-gradient shadow-glow">
            ...
            {isMounted ? (
              ...
              <div className="space-y-4" suppressHydrationWarning>
                <div className="h-10 rounded-lg bg-dark-lighter/80 border border-gray-700" />
                <div className="h-10 rounded-lg bg-dark-lighter/80 border border-gray-700" />
                <div className="h-28 rounded-lg bg-dark-lighter/80 border border-gray-700" />
                <div className="h-12 rounded-lg bg-primary-cyan/30" />
              </div>
            )}
          </div>
        </div>
