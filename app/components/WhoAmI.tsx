...
export default function AboutMe() {
  ...
  useEffect(() => {
    async function fetchAboutImages() {
      try {
        const data = await queryNotionDatabase(ABOUT_IMAGES_DATABASE_ID)
        const images = data.results.map(transformAboutImage)
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="relative">
            <div className="aspect-w-16 aspect-h-9 relative h-[400px] group">
              {isLoadingSlides ? (
                <div className="absolute inset-0 shimmer rounded-lg" aria-hidden="true" />
              ) : slidesError ? (
                ...
                <>
                  ...
                  {isPaused && (
                    <div className="absolute top-4 right-4 bg-black/50 backdrop-blur-sm p-2 rounded-full shadow-lg z-20">
                      <CountdownPieClock
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end z-10">
            ...
            {!isLoadingSlides && !slidesError && slidesData.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 p-3 rounded-full text-white transition-all duration-300 transform hover:scale-110 z-20"
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 p-3 rounded-full text-white transition-all duration-300 transform hover:scale-110 z-20"
                ...
                {/* Slide counter */}
                <div className="absolute bottom-4 right-4 bg-black/50 text-white px-2 py-1 rounded text-sm z-20">
