...
import { queryNotionDatabase, SKILLS_DATABASE_ID, transformSkill, groupSkills } from "@/lib/notion-morphic"
...
export default function Skills() {
  ...
  useEffect(() => {
    async function fetchSkills() {
      try {
        const data = await queryNotionDatabase(SKILLS_DATABASE_ID)
        const rawSkills = data.results.map(transformSkill)
        const skillsData = groupSkills(rawSkills)
